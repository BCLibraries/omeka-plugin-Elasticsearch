...
class Model_AggregationListTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->list = Elasticsearch_Model_AggregationList::build();
    ...
    public function testCanAddAggregations(): void
    {
        ...
        $this->list->add($this->agg1)->add($this->agg2);
    ...
    public function testCanBuildWithAggregationsList(): void
    {
        ...
        $list = Elasticsearch_Model_AggregationList::build([$this->agg1, $this->agg2]);
