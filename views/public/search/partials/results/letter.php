...
<?php if ($result_img): ?>
    <a href="<?php echo $url; ?>"><?php echo $result_img; ?></a>
<?php endif; ?>
...
<ul>
    ...
    <li title="created">
        <b>Record Created: </b> <?php echo Elasticsearch_Utils::formatDate($hit['_source']['created']); ?></li>
    <li title="updated">
        <b>Record Updated: </b> <?php echo Elasticsearch_Utils::formatDate($hit['_source']['updated']); ?></li>
</ul>
