<div class="elasticsearch-result">
    ...
    <?php $url = isset($hit['_source']['url']) ? public_url($hit['_source']['url']) : record_url($record); ?>
    <?php $title = !empty($hit['_source']['title']) ? $hit['_source']['title'] : __('Untitled') . ' ' . $hit['_source']['resulttype']; ?>

    <h3><a href="<?php echo $url; ?>" title="<?php echo htmlspecialchars($title); ?>"><?php echo $title; ?></a></h3>
